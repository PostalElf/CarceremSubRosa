Module Module1
    ...
    Sub Main()
        ...
        Dim stage1 As New missionStage("Dress Up", 5, 10, New Dictionary(Of choiceComponent, Integer) From {{choiceComponent.Diplomacy, 1}}, New List(Of String) From {"stonewall"}, 1)
        Dim stage2 As New missionStage("Travel to the Party", 7, 10, Nothing, New List(Of String) From {"stonewall"}, 1)
        Dim stage3 As New missionStage("Eat!", 7, 10, Nothing, New List(Of String) From {"stonewall"}, 1)
        Dim stage4 As New missionStage("Kill", 18, 10, Nothing, New List(Of String) From {"health"}, 5)
