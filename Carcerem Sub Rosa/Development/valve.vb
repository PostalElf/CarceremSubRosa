...
Module valve
    ...
    Private Function sign(value As Decimal) As String
        If value < 0 Then Return "-" Else Return "+"
    End Function
    Public Function withSign(value As Decimal, Optional prefix As String = "") As String
    ...
    End Function
    Public Function withReverseSign(value As Decimal, Optional prefix As String = "") As String
